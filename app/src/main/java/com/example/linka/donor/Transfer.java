...
public class Transfer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tranferBtn=findViewById(R.id.transferBtn);
        ttf1=findViewById(R.id.ttf1);
        ttf2=findViewById(R.id.ttf2);
        ...
        navigation.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch(id){
                    case R.id.home: {
                        Intent in = new Intent(Transfer.this, MainPage.class);
                        startActivity(in);
                        break;
                    }case R.id.search:{
                        Intent in= new Intent(Transfer.this, Search.class);
                        startActivity(in);break;
                    }case R.id.history:{
                        Intent in=new Intent(Transfer.this, History.class);
                        startActivity(in);break;
                    }case R.id.transfer:{
                        Intent in= new Intent(Transfer.this, Transfer.class);
                        startActivity(in);break;
                    }case R.id.withdraw:{
                    ...
                    databaseReference.child("client").addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            ...
                            if(units>=tttf2){
                                ...
                                transaction tr=new transaction(datetime,id,tf1,"t",tf2);
                                ...
                                Toast.makeText(Transfer.this,"You don't have sufficient credits.",Toast.LENGTH_SHORT).show();
                            }
                        }
                        @Override
